...
type APPListItemOutput struct {
	...
	UpdatedAt public.LocalTime `json:"create_at" gorm:"column:create_at" description:"添加时间	"`
	CreatedAt public.LocalTime `json:"update_at" gorm:"column:update_at" description:"更新时间"`
